...
export default function NavBar({ user, setUser }) {
  ...
  <div className="container-fluid mb-6">
    ...
    <img src="https://media.istockphoto.com/id/1178705635/vector/web.jpg?s=612x612&w=0&k=20&c=E4ednGAGu92EMICMgw6O1DUaH7NGGQwdhd4pYMAXPyg=" height={90}/>
    ...
    <div className="collapse navbar-collapse ">
     ...
     {!user ? (
      <>
        ...
        <Link className="btn bg-white text-black mx-1" to="/login"> Login 
        </Link>
         <Link className="btn bg-white text-black mx-1" to="/createuser"> Sign Up 
        </Link>
      </>
...
<Link className="btn bg-white text-black mx-2" onClick={handleLogOut}>Log Out</Link>
</>)}
</div>
